...
public class MainShip extends Ship {
    ...
    public void startNewGame() {
        ...
        this.hp = 1;
        flushDestroy(); //если корабль помечен на удаление, сниметсся пометка
    ...
    //у buhjrf прямоугольник. Пуля попадает не долетая корабля. Теперь хит бокс в центр корабля
