...
public class Regions {
    ...
    //с этим массивом мы работаем как с кадрами на пленке
    //для получения анимации или переключения состояния коробля
